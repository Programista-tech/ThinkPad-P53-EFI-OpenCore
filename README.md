...
| **Karta sieciowa (LAN)** | Intel Ethernet Connection I219-LM | ✅ Działa |
| **Karta Wi-Fi / BT** | Intel Wi-Fi 6 AX200 | ✅ Działa (AirportItlwm / IntelBluetooth) |
...
- **Obsługa dysków NVMe:** ⚠️ **Tymczasowo wyłączona** ze względu na specyficzny/niekompatybilny dysk NVMe używany w konfiguracji testowej. 
  > *Uwaga: Aby zainstalować system na własnym dysku, należy włączyć/dodać odpowiedni kext (np. `NVMeFix.kext`) lub odblokować kontroler NVMe w pliku `config.plist` w zależności od posiadanego modelu SSD.*
...
3. Dostosuj kexty/sterowniki dysku NVMe do swojego sprzętu przed przystąpieniem do instalacji.
